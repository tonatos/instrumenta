        ...
        <main id="top">
          <section className="hero shell">
            <div className="hero__copy reveal">
              ...
              <p className="hero__lead">
                Instrumenta — информационно‑аналитический инструмент: подбирает
                математически подходящие короткие бумаги под выбранный риск‑профиль,
          ...
          <section className="section shell" id="strategy">
            ...
            <div className="strategy-grid">
              ...
              <article className="strategy-card reveal">
                ...
                <h3>Математика под риск‑профиль</h3>
                <p>
                  Conservative, Normal, Aggressive — разные веса доходности, риска
                  и ликвидности. Сервис показывает математически подходящие
                  варианты под выбранный профиль, а не «советует купить именно эту
                  бумагу».
                </p>
              </article>
              <article className="strategy-card reveal">
          ...
          <section className="section shell" id="how">
            <div className="section__head reveal">
              ...
              <p>
                Четыре шага от профиля до исполнения. Скринер, радар и алерты —
            ...
            <div className="feature-grid">
              <article className="feature-card reveal">
                ...
                <h3>Выбираете риск‑профиль</h3>
                <p>
                  Задаёте горизонт и профиль. Дальше скоринг и фильтры работают в
                  одной логике — и в симуляции, и при подборе.
                </p>
              </article>
              <article className="feature-card reveal">
                <span className="tag tag--blue">2</span>
                <h3>Математический автоподбор</h3>
                <p>
                  Система собирает корзину из подходящих коротких бумаг: рейтинг,
                  ликвидность, YTM и ограничения профиля.
                </p>
              </article>
              <article className="feature-card reveal">
                <span className="tag tag--amber">3</span>
                <h3>Фиксируете план закупок</h3>
                <p>
          ...
          <section className="section shell" id="portfolio">
            <div className="split reveal">
              <div className="split__copy">
                ...
                <h2>Зафиксировали план — и спокойно исполняете</h2>
                <p>
          ...
          <section className="final-cta shell" id="cta">
            <div className="final-cta__card reveal">
              ...
              <p>
                Войдите через Telegram, выберите риск‑профиль и соберите расчётный
        ...
        <footer className="footer">
          <div className="shell">
            ...
            <p className="footer__legal">
              ...
              использование). Сервис носит информационно‑аналитический характер и не
              является индивидуальной инвестиционной рекомендацией. Расчётные
              показатели носят модельный характер. Решения о сделках принимает
              пользователь самостоятельно. Исполнитель: Семячкин Виталий Юрьевич,
              ИНН 660608518305.
            </p>
          </div>
        </footer>
