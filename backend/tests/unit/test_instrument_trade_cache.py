...
from bond_monitor.application.trading.trading_service import _block_non_api_tradable_pending
...
def test_block_non_api_tradable_pending_uses_cached_tradable_result() -> None:
    ...
    with patch(
        ...
        _block_non_api_tradable_pending(portfolio, "token", pending, _snapshot())
